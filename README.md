...
```bash
git clone https://github.com/kalwhyte/AirBnB_clone.git
```
...
## Authors
<details>
    <summary>Emmanuel Arinze</summary>
    <ul>
    <li><a href="https://www.github.com/kal_whyte">Github</a></li>
    <li><a href="https://www.twitter.com/kal_whyte">Twitter</a></li>
    <li><a href="mailt:superkalel55@gmail.com">e-mail</a></li>
    </ul>
</details>
<details>
    <summary></summary>
